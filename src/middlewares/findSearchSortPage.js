...
module.exports = (req, res, next) => {
  ...
  //   buraya bir model ismi gelicek. res yazdığımız için artık bunu her yerde kullanabiliriz.
  res.getModelList = async function (Model, populate = null) {
    // + filter süzgeç = gibi çalışır, birebir aynısı, search ise içinde geçeni geçirir.
